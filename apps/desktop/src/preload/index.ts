...
const api: VoApi = {
  ...
  mcpOauthBegin: (serverName) => ipcRenderer.invoke(IPC.mcpOauthBegin, serverName),
  mcpOauthSignOut: (serverName) => ipcRenderer.invoke(IPC.mcpOauthSignOut, serverName),
  ...
  projectOpenExisting: (dir) => ipcRenderer.invoke(IPC.projectOpenExisting, dir),
  ...
  groupDelete: (groupId) => ipcRenderer.invoke(IPC.groupDelete, groupId),
